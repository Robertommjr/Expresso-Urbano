...
namespace ExpressoUrbano.Infrastructure.IdentityConfig
{
    public class EmailService : IIdentityMessageService
    {
        ...
        private Task SendMail(IdentityMessage message)
        {
            if (ConfigurationManager.AppSettings["Internet"] == "true")
            {
                ...
                msg.From = new MailAddress(ConfigurationManager.AppSettings["mailAccount"], "Admin do Portal");
                ...
                var smtpClient = new SmtpClient("smtp.rcs.srv.br", Convert.ToInt32(587));
