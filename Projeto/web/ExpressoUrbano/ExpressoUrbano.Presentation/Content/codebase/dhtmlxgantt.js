...
function() {
    ...
    gantt._init_template = function(t, e, n) {
        ...
        n = n || t,
        this.config[t] && a[n] != this.config[t] && (e && this.templates[n] || (this.templates[n] = this.date.date_to_str(this.config[t]),
        a[n] = this.config[t])),
    ...
    gantt._init_templates = function() {
        ...
        gantt.mixin(this.templates, {
            ...
            drag_link: function(t, e, n, a) {
                ...
                s += "<b> " + n.text + "</b> " + (a ? i.link_start : i.link_end) + "<br/>"),
                s
            },
...
gantt._on_contextmenu = function(t) {
    ...
    return i || (t.preventDefault ? t.preventDefault() : t.returnValue = !1),
    i
}
,
...
gantt._DnD = function(t, e) {
    ...
    gantt.attachEvent("onGanttScroll", gantt.bind(function(t, e) {
        this.clearDragTimer()
    }, this)),
    gantt.event(t, this._evs.down, gantt.bind(function(n) {
        e.original_target = {
            target: n.target || n.srcElement
        },
        gantt.config.touch ? (this.clearDragTimer(),
        this._drag_start_timer = setTimeout(gantt.bind(function() {
            this.dragStart(t, n)
        }, this), gantt.config.touch_drag)) : this.dragStart(t, n)
    }, this)),
    gantt.event(document.body, this._evs.up, gantt.bind(function(t) {
        this.clearDragTimer()
    }, this))
}
,
gantt._DnD.prototype = {
    traceDragEvents: function(t) {
        ...
        gantt.bind(function(t) {
            ...
            gantt.defined(this.config.updates_per_second) && !gantt._checkTimeout(this, this.config.updates_per_second) ? !0 : e(t)
        }, this))
          , a = gantt.bind(function(e) {
            return gantt.eventRemove(document.body, this._evs.move, n),
            gantt.eventRemove(document.body, this._evs.up, a),
            this.dragEnd(t)
        }, this);
        gantt.event(document.body, this._evs.move, n),
        gantt.event(document.body, this._evs.up, a)
    },
    ...
    initEventAccessor: function() {
        ...
        ,
        gantt.config.touch && (window.navigator.msPointerEnabled ? (t.move = "MSPointerMove",
    ...
    dragStart: function(t, e) {
        ...
        this.traceDragEvents(t),
        gantt._prevent_touch_scroll = !0,
        document.body.className += " gantt_noselect",
        gantt.config.touch && this.dragMove(t, e);
    },
    dragMove: function(t, e) {
        ...
        if (n) {
            ...
            return this.config.ignore ? void 0 : (n.pos = this.getPosition(n),
...
gantt._init_grid = function() {
    ...
    this._click.gantt_open = this.bind(function(t, e, n) {
        return this.open(e),
        !1
    }, this),
    this._click.gantt_row = this.bind(function(t, e, n) {
        if (null !== e) {
            var a = this.getTask(e);
            this.config.scroll_on_click && this.showDate(a.start_date),
            this.callEvent("onTaskRowClick", [e, n])
        }
    }, this),
    this._click.gantt_grid_head_cell = this.bind(function(t, e, n) {
    ...
    this._click.gantt_add = this.bind(function(t, e, n) {
        if (!this.config.readonly) {
            var a = {};
            return this.createTask(a, e ? e : this.config.root_id),
            !1
        }
    }, this),
...
gantt._render_grid_header = function() {
    for (var t = this.getGridColumns(), e = [], n = 0, a = this.locale.labels, i = this.config.scale_height - 2, s = 0; s < t.length; s++) {
        var r = s == t.length - 1
          , o = t[s]
          , _ = 1 * o.width;
        r && this._get_grid_width() > n + _ && (o.width = _ = this._get_grid_width() - n),
        n += _;
    ...
    this.$grid_scale.style.lineHeight = i + "px",
...
gantt._render_grid_item = function(t) {
    ...
    for (var e, n = this.getGridColumns(), a = [], i = 0; i < n.length; i++) {
        ...
        if ("add" == l.name) {
            ...
            r = "<div " + d + " class='gantt_add'></div>",
            o = ""
        } else
            r = l.template ? l.template(t) : t[l.name],
            r instanceof Date && (r = this.templates.date_grid(r, t)),
            o = r,
        ...
        if (l.tree) {
            ...
            e = this._has_children(t.id),
            e ? (h += this.templates.grid_open(t),
            h += this.templates.grid_folder(t)) : (h += this.templates.grid_blank(t),
        ...
        s = "<div class='" + g + "' style='" + u + "' " + d + ">" + h + r + "</div>",
        a.push(s)
    }
    var g = gantt.getGlobalTaskIndex(t.id) % 2 === 0 ? "" : " odd";
    if (g += t.$transparent ? " gantt_transparent" : "",
    ...
    return p.className = "gantt_row" + g,
    p.style.height = this.config.row_height + "px",
    p.style.lineHeight = gantt.config.row_height + "px",
    p.setAttribute(this.config.task_attribute, t.id),
    this._waiAria.taskRowAttr(t, p),
    p.innerHTML = a.join(""),
    p
}
,
...
gantt.moveTask = function(t, e, n) {
    ...
    if (t != n) {
        ...
        if (this.callEvent("onBeforeTaskMove", [t, n, e]) !== !1) {
            ...
            var _ = r[e];
            _ ? r = r.slice(0, e).concat([t]).concat(r.slice(e)) : r.push(t),
            this.setParent(i, n),
            this._branches[n] = r;
...
gantt._init_dnd = function() {
    ...
    t.attachEvent("onAfterDragStart", this.bind(function(e, n) {
        var a = this._locateHTML(n);
        t.config.marker.innerHTML = a.outerHTML,
        t.config.id = this.locate(n);
        var i = this.getTask(t.config.id);
        t.config.index = this.getTaskIndex(t.config.id),
        t.config.parent = i.parent,
        i.$open = !1,
        i.$transparent = !0,
        this.refreshData()
    }, this)),
    ...
    t._getGridPos = this.bind(function(t) {
        ...
        return a > e.y + i - this.config.row_height && (a = e.y + i - this.config.row_height),
        e.x = n,
        e.y = a,
        e
    }, this),
    t._getTargetY = this.bind(function(t) {
        var e = this._get_position(this.$grid_data)
          , n = t.pageY - e.y + gantt.getScrollState().y;
        return 0 > n && (n = 0),
        n
    }, this),
    t._getTaskByY = this.bind(function(t, e) {
        t = t || 0,
        gantt.config.smart_rendering && (t += this.$grid_data.scrollTop);
        var n = Math.floor(t / this.config.row_height);
        return n = n > e ? n - 1 : n,
        n > this._order.length - 1 ? null : this._order[n];
    }, this),
    t.attachEvent("onDragMove", this.bind(function(e, n) {
        function a(t, e) {
            return !gantt.isChildOf(l.id, e.id) && (t.$level == e.$level || gantt.config.order_branch_free)
        }
        var i = t.config
          , s = t._getGridPos(n);
        i.marker.style.left = s.x + 10 + "px",
        ...
        this.isTaskExists(_)) {
            ...
            if (gantt.getGlobalTaskIndex(l.id) * this.config.row_height + this.config.row_height / 2 < o) {
                ...
                if (g) {
                    ...
                    l = g
                } else if (g = this._pull[this._order[d]],
                a(g, r) && g.id != r.id)
...
function() {
    ...
    gantt._waiAria = {
        ...
        _taskCommonAttr: function(e, n) {
            ...
            e.$dataprocessor_class && n.setAttribute("aria-busy", !0),
            n.setAttribute("aria-selected", gantt.getState().selected_task == e.id || gantt.isSelectedTask && gantt.isSelectedTask(e.id) ? "true" : "false")
        },
        ...
        taskRowAttr: function(t, e) {
            this._taskCommonAttr(t, e),
            !gantt._is_readonly(t) && gantt.config.order_branch && e.setAttribute("aria-grabbed", !1),
            e.setAttribute("role", "row"),
            e.setAttribute("aria-level", t.$level),
            gantt._has_children(t.id) && e.setAttribute("aria-expanded", t.$open ? "true" : "false")
        },
...
gantt._scale_helpers = {
    ...
    setSumWidth: function(t, e, n, a) {
        var i = e.width;
        void 0 === a && (a = i.length - 1),
        void 0 === n && (n = 0);
        var s = a - n + 1;
        if (!(n > i.length - 1 || 0 >= s || a > i.length - 1)) {
            var r = this.getSum(i, n, a)
              , o = t - r;
            this.adjustSize(o, i, n, a),
            this.adjustSize(-o, i, a + 1),
    ...
    _ignore_time_config: function(t, e) {
        if (this.config.skip_off_time) {
            for (var n = !0, a = t, i = 0; i < e.step; i++)
                i && (a = gantt.date.add(t, i, e.unit)),
                n = n && !this.isWorkTime(a, e.unit);
            return n
        }
        return !1
    },
...
gantt._tasks_dnd = {
    ...
    set_actions: function() {
        ...
        gantt.event(t, "mousedown", gantt.bind(function(t) {
            this.on_mouse_down(t || event)
        }, this)),
        gantt.event(t, "mouseup", gantt.bind(function(t) {
    ...
    _resize: function(t, e, n) {
        ...
        t.start_date || (t.start_date = new Date(gantt.getState().min_date))) : (t.end_date = gantt.dateFromPos(i.end + e),
        t.end_date || (t.end_date = new Date(gantt.getState().max_date))),
        t.end_date - t.start_date < a.min_duration && (n.left ? t.start_date = gantt.calculateEndDate(t.end_date, -1) : t.end_date = gantt.calculateEndDate(t.start_date, 1)),
    ...
    _move: function(t, e, n) {
        ...
        t.start_date = gantt.dateFromPos(gantt.posFromDate(t.end_date) - (a.end - a.start))) : (t.start_date = new Date(gantt.getState().min_date),
        t.end_date = gantt.dateFromPos(gantt.posFromDate(t.start_date) + (a.end - a.start)))
    },
    ...
    on_mouse_down: function(t, e) {
        if (2 != t.button) {
            var n = gantt.locate(t)
              , a = null ;
            if (gantt.isTaskExists(n) && (a = gantt.getTask(n)),
    ...
    _fix_dnd_scale_time: function(t, e) {
        ...
        var i = gantt._tasks.unit
          , s = gantt._tasks.step;
        gantt.config.round_dnd_dates || (i = "minute",
    ...
    on_mouse_up: function(t) {
        ...
        if (e.mode && e.id) {
            ...
            this._fireEvent("before_finish", e.mode, [e.id, e.mode, gantt.copy(e.obj), t])) {
                var a = e.id;
                gantt._init_task_timing(n),
                this.clear_drag_state(),
    ...
    _get_drag_mode: function(t) {
        ...
        case "gantt_task_drag":
            i.mode = e.resize,
            n[1] && -1 !== n[1].indexOf("left", n[1].length - "left".length) ? i.left = !0 : i.left = !1;
            break;
    ...
    _start_dnd: function(t) {
        ...
        var n = gantt.config
          , a = e.id;
        n["drag_" + e.mode] && gantt.callEvent("onBeforeDrag", [a, e.mode, t]) && this._fireEvent("before_start", e.mode, [a, e.mode, t]) ? (delete e.start_drag,
    ...
    _fireEvent: function(t, e, n) {
        ...
        gantt.assert(n, "Invalid event arguments"),
...
gantt.isLinkAllowed = function(t, e, n, a) {
    ...
    if (i.source == i.target)
        return !1;
    var s = !0;
    return this.checkEvent("onLinkValidation") && (s = this.callEvent("onLinkValidation", [i])),
    s
}
,
gantt._render_link_element = function(t) {
    ...
    i.className = s,
    i.setAttribute(gantt.config.link_attribute, t.id);
    for (var o = 0; o < a.length; o++) {
        o == a.length - 1 && (a[o].size -= gantt.config.link_arrow_size);
        var _ = n.render_line(a[o], a[o + 1]);
        t.color && (_.firstChild.style.backgroundColor = t.color),
        i.appendChild(_)
    }
    var l = a[a.length - 1].direction
      , d = gantt._render_link_arrow(e[e.length - 1], l);
    return t.color && (d.style.borderColor = t.color),
    i.appendChild(d),
    gantt._waiAria.linkAttr(t, i),
    i
}
,
...
gantt._drawer = {
    ...
    render_line: function(t) {
        ...
        var a = this.get_line_sizes(t)
          , i = document.createElement("div");
        return i.style.cssText = ["height:" + a.height + "px", "width:" + a.width + "px", "margin-top:" + a.marginTop + "px", "margin-left:" + a.marginLeft + "px"].join(";"),
        i.className = "gantt_link_line_" + t.direction,
        n.appendChild(i),
        n
    },
...
gantt._path_builder = {
    ...
    point: function(t) {
        return t ? (this.path.push(gantt.copy(t)),
        t) : this.current()
    },
    ...
    get_points: function(t) {
        ...
        if (t.type == gantt.config.links.start_to_start)
            ...
            o ? (this.point_to(s.down, a),
            this.point_to(s.right, i)) : (this.point_to(s.right, i),
            ...
            o)
                i -= r,
                this.point_to(s.down, a),
                this.point_to(s.right, i);
            else {
                i -= 2 * r;
                var _ = a > 0 ? 1 : -1;
                this.point_to(s.down, _ * (n.row_height / 2)),
                this.point_to(s.right, i),
                this.point_to(s.down, _ * (Math.abs(a) - n.row_height / 2)),
                this.point_to(s.right, r)
            }
        else if (t.type == gantt.config.links.finish_to_finish)
            this.point_to(s.right, r),
            o ? (this.point_to(s.right, i),
            this.point_to(s.down, a)) : (this.point_to(s.down, a),
            this.point_to(s.right, i)),
            this.point_to(s.left, r);
    ...
    get_endpoint: function(t) {
        var e = gantt.config.links
          , n = !1
          , a = !1;
        t.type == e.start_to_start ? n = a = !0 : t.type == e.finish_to_finish ? n = a = !1 : t.type == e.finish_to_start ? (n = !1,
        a = !0) : t.type == e.start_to_finish ? (n = !0,
        a = !1) : gantt.assert(!1, "Invalid link type");
...
gantt._init_links_dnd = function() {
    function t(t, e, n) {
        ...
        return a.y += gantt._get_task_height() / 2,
        n = n || 0,
        a.x += (e ? -1 : 1) * n,
        a
    }
    ...
    function _() {
        return d._direction || (d._direction = document.createElement("div"),
        gantt.$task_links.appendChild(d._direction)),
        d._direction
    }
    function l() {
        d._direction && (d._direction.parentNode && d._direction.parentNode.removeChild(d._direction),
        d._direction = null )
    }
    ...
    d.attachEvent("onAfterDragStart", gantt.bind(function(t, n) {
        this.config.touch && (this._show_link_points = !0,
        this.refreshData()),
        e(d.config.marker)
    }, this)),
    d.attachEvent("onDragMove", gantt.bind(function(a, i) {
        var r = d.config
          , o = d.getPosition(i);
        n(r.marker, o);
    ...
    d.attachEvent("onDragEnd", gantt.bind(function() {
        ...
        i(),
        this.config.touch ? (this._show_link_points = !1,
        this.refreshData()) : (t.from && gantt.refreshTask(t.from, !1),
...
gantt._task_renderer = function(t, e, n, a) {
    ...
    this._task_area_renderers[t] ? this._task_area_renderers[t] : (e || this.assert(!1, "Invalid renderer call"),
    ...
    this._task_area_renderers[t] = {
        ...
        append: function(t, e, n) {
            return e ? (this.rendered[t.id] && this.rendered[t.id].parentNode ? this.replace_item(t.id, e) : n.appendChild(e),
...
gantt._init_tasks = function() {
    ...
    this._click.gantt_scale_cell = this.bind(function(t, e) {
        var n = gantt._get_mouse_pos(t)
    ...
    this._dbl_click.gantt_link_point = this.bind(function(t, e, n) {
        var e = this.locate(t)
          , a = this.getTask(e)
          , i = null ;
        return n.parentNode && gantt._getClassName(n.parentNode) && (i = gantt._getClassName(n.parentNode).indexOf("_left") > -1 ? a.$target[0] : a.$source[0]),
        i && this._delete_link_handler(i, t),
        !1
    }, this),
...
gantt._filter_task = function(t, e) {
    ...
    +e.start_date > a || +e.end_date < +n) ? !1 : !0
}
,
...
gantt._update_layout_sizes = function() {
    ...
    this.$task_data.style.height = Math.max(e - this.config.scale_height, 0) + "px",
    gantt.config.smart_rendering ? this.$task_bg.style.height = gantt.config.row_height * this.getVisibleTaskCount() + "px" : this.$task_bg.style.height = "",
...
gantt._init_tasks_range = function() {
    ...
    if (this.config.start_date && this.config.end_date) {
        ...
        return e = +e != +n ? this.date.add(n, 1, t) : n,
        void (this._max_date = e)
    }
    this._get_tasks_data();
    var a = this.getSubtaskDates();
    this._min_date = a.start_date,
    this._max_date = a.end_date,
...
gantt._prepare_scale_html = function(t, e, n) {
    ...
    var o = 0
      , _ = t.count - 1;
    !this.config.smart_scales || isNaN(e) || isNaN(n) || (o = this._findBinary(t.left, e),
    ...
    for (var l = o; _ > l && t.trace_x[l]; l++) {
        ...
        if (g) {
            ...
            p = "gantt_scale_cell" + (l == t.count - 1 ? " gantt_last_cell" : ""),
            f = r.call(this, i),
            f && (p += " " + f);
...
gantt._render_tasks_scales = function() {
    ...
    this.$task_scale.style.height = a,
...
gantt._render_bg_line = function(t) {
    ...
    if (gantt.config.show_task_cells)
        for (var i = 0; n > i; i++) {
            ...
            if (s > 0) {
                ...
                o.style.width = s + "px",
                r = "gantt_task_cell" + (i == n - 1 ? " gantt_last_cell" : ""),
                l = this.templates.task_cell_class(t, e.trace_x[i]),
                l && (r += " " + l),
                o.className = r,
                a.appendChild(o)
            }
    ...
    return this.getState().selected_task == t.id && (d += " gantt_selected"),
    a.className = d,
    gantt.config.smart_rendering && (a.style.position = "absolute",
    a.style.top = this.getTaskTop(t.id) + "px",
    a.style.width = "100%"),
    a.style.height = gantt.config.row_height + "px",
    a.setAttribute(this.config.task_attribute, t.id),
    a
}
,
...
gantt._combine_item_class = function(t, e, n) {
    ...
    this.config.select_task && n == i.selected_task && a.push("gantt_selected"),
    n == i.drag_id && (a.push("gantt_drag_" + i.drag_mode),
    i.touch_drag && a.push("gantt_touch_" + i.drag_mode));
    var r = gantt._get_link_state();
    if (r.link_source_id == n && a.push("gantt_link_source"),
    r.link_target_id == n && a.push("gantt_link_target"),
    this.config.highlight_critical_path && this.isCriticalTask && this.isCriticalTask(s) && a.push("gantt_critical_task"),
    r.link_landing_area && r.link_target_id && r.link_source_id && r.link_target_id != r.link_source_id) {
        var o = r.link_source_id
          ...
          , g = "";
        g = d ? l ? "link_start_allow" : "link_finish_allow" : l ? "link_start_deny" : "link_finish_deny",
        a.push(g)
    }
    return a.join(" ")
}
...
gantt._render_pair = function(t, e, n, a) {
    var i = gantt.getState();
    +n.end_date <= +i.max_date && t.appendChild(a(e + " task_right")),
    +n.start_date >= +i.min_date && t.appendChild(a(e + " task_left"))
}
,
...
gantt._task_default_render = function(t) {
    if (!this._isAllowedUnscheduledTask(t)) {
        ...
        t.textColor && (_.style.color = t.textColor),
        s.appendChild(_);
        ...
        s.className = l;
        var d = ["left:" + e.x + "px", "top:" + (i + e.y - 2) + "px", "height:" + (a + 4) + "px", "z-index:5", "line-height:" + a + "px", "width:" + r + "px"];
        t.color && d.push("background-color:" + t.color),
        t.textColor && d.push("color:" + t.textColor),
        s.style.cssText = d.join(";");
        var g = this._render_leftside_content(t);
        return g && s.appendChild(g),
        g = this._render_rightside_content(t),
        g && s.appendChild(g),
        gantt._waiAria.setTaskBarAttr(t, s),
        ...
        n.drag_links && this.config.show_links && gantt._render_pair(s, "gantt_link_control", t, function(t) {
            ...
            n.style.display = gantt._show_link_points ? "block" : "",
            e.appendChild(n),
            e
        })),
        s
...
gantt._render_task_element = function(t) {
    ...
    return n || (n = a),
    n.call(this, t, this.bind(a, this))
}
,
gantt._render_side_content = function(t, e, n) {
    ...
    return i.className = "gantt_side_content " + n,
    i.innerHTML = a,
    i
}
,
...
gantt._render_task_progress = function(t, e, n) {
    ...
    var i = document.createElement("div")
      , s = Math.round(n * a);
    if (s = Math.min(n, s),
    t.progressColor && (i.style.backgroundColor = t.progressColor,
    i.style.opacity = 1),
    i.style.width = s + "px",
...
gantt.posFromDate = function(t) {
    ...
    a && (i += n < gantt._tasks.width.length ? gantt._tasks.width[n] * (a % 1) : 1),
    i
}
,
...
gantt._get_mouse_pos = function(t) {
    ...
    return e.x = e.x - a.x + gantt.$task_data.scrollLeft,
    e.y = e.y - a.y + gantt.$task_data.scrollTop,
    e
}
,
gantt._is_layer = function(t) {
...
gantt.load = function(t, e, n) {
    ...
    var a = "json"
      , i = null ;
    arguments.length >= 3 ? (a = e,
    i = n) : "string" == typeof arguments[1] ? a = arguments[1] : "function" == typeof arguments[1] && (i = arguments[1]),
    this._load_type = a,
    this.callEvent("onLoadStart", [t, a]),
    this.ajax.get(t, gantt.bind(function(e) {
        this.on_load(e, a),
        this.callEvent("onLoadEnd", [t, a]),
...
gantt._sync_order_item = function(t, e) {
    t.id !== gantt.config.root_id && (this._order_full.push(t.id),
...
gantt._eachParent = function(t, e, n) {
    ...
    for (var a = e; this.getParent(a) && this.isTaskExists(this.getParent(a)); )
        a = this.getTask(this.getParent(a)),
        t.call(n, a);
}
,
gantt.json = {
    parse: function(t) {
        return gantt.assert(t, "Invalid data"),
        "string" == typeof t && (window.JSON ? t = JSON.parse(t) : gantt.assert(!1, "JSON is not supported")),
        t.dhx_security && (gantt.security_key = t.dhx_security),
        t
    },
...
gantt._working_time_helper = {
    ...
    set_time: function(t) {
        var e = void 0 !== t.hours ? t.hours : !0
          , n = this._timestamp(t);
        null !== n ? this.get_calendar().dates[n] = e : this.get_calendar().hours = e,
    ...
    is_working_unit: function(t, e, n) {
        ...
        return -1 == a && (a = this._check_is_working_unit(t, e, n),
        this._working_units_cache.put(e, t, a)),
        a
    },
    _check_is_working_unit: function(t, e, n) {
        return void 0 === n && (n = this._get_unit_order(e)),
        void 0 === n ? !0 : n && !this.is_working_unit(t, this.units[n - 1], n - 1) ? !1 : this["is_work_" + e] ? this["is_work_" + e](t) : !0
    },
    ...
    get_working_hours: function(t) {
        var e = this._timestamp({
          ...
          , n = !0
          , a = this.get_calendar();
        return void 0 !== a.dates[e] ? n = a.dates[e] : void 0 !== a.dates[t.getDay()] && (n = a.dates[t.getDay()]),
        n === !0 ? a.hours : n ? n : []
    },
    intern_dates_pull: {},
    ...
    get_work_hours_for_range: function(t, e) {
        for (var n = 0, a = new Date(t), i = new Date(e); a.valueOf() < i.valueOf(); )
            this.is_working_unit(a, "day") && (n += this.get_hours_per_day(a)),
            a = this.next_date(a, "day", 1);
        return n
    },
    ...
    add_worktime: function(t, e, n, a) {
        ...
        if (gantt.config.work_time) {
            for (; e > s; ) {
                ...
                this.is_working_unit(a > 0 ? new Date(r.valueOf() - 1) : new Date(r.valueOf() + 1), n) && s++,
                i = r
            }
            return i
        }
    ...
    get_closest_worktime: function(t) {
        ...
        for ("past" == t.dir && (l = -1); !this.is_working_unit(n, e); ) {
            ...
            o++,
            o > r)
                return gantt.assert(!1, "Invalid working time check"),
                !1
        }
        return (n == i || "past" == t.dir) && (n = gantt.date.add(n, 1, e)),
        n
    }
},
...
gantt.getTask = function(t) {
    ...
    var e = this._pull[t];
    return gantt.assert(e, "Task not found id=" + t),
    e
}
,
...
gantt.updateTask = function(t, e) {
    return gantt.defined(e) || (e = this.getTask(t)),
...
gantt._add_branch = function(t, e) {
    ...
    i || (1 * e == e ? a.splice(e, 0, t.id) : a.push(t.id)),
    this._sync_parent(t)
}
,
...
gantt.addTask = function(t, e, n) {
    return gantt.defined(e) || (e = this.getParent(t) || 0),
...
gantt._init_task = function(t) {
    ...
    e && (t.start_date && !t.end_date ? t.end_date = this.calculateEndDate(t.start_date, t.duration) : !t.start_date && t.end_date && (t.start_date = this.calculateEndDate(t.end_date, -t.duration))),
    ...
    gantt.defined(t.$open) || (t.$open = gantt.defined(t.open) ? t.open : this.config.open_tree_initially),
    t.$level = this.calculateTaskLevel(t),
    t
}
,
...
gantt._update_parents = function(t, e) {
    if (t) {
        ...
        if (n.$no_start || n.$no_end) {
            ...
            gantt.resetProjectDates(n),
            s == n.start_date.valueOf() && r == n.end_date.valueOf() && (i = !1),
            i && !e && this.refreshTask(n.id, !0)
        }
...
gantt.roundDate = function(t) {
    ...
    if (r == gantt._tasks.unit && s == gantt._tasks.step && +i >= +gantt._min_date && +i <= +gantt._max_date)
        ...
        gantt._tasks.trace_x[a] || (a -= 1),
        n = new Date(gantt._tasks.trace_x[a]),
        e = new Date(n),
        e = gantt._tasks.trace_x[a + 1] ? new Date(gantt._tasks.trace_x[a + 1]) : gantt.date.add(n, s, r);
    else {
        for (a = Math.floor(gantt._day_index_by_date(i)),
        e = gantt.date[r + "_start"](new Date(this._min_date)),
        gantt._tasks.trace_x[a] && (e = gantt.date[r + "_start"](gantt._tasks.trace_x[a])); +i > +e; ) {
            e = gantt.date[r + "_start"](gantt.date.add(e, s, r));
            var o = e.getTimezoneOffset();
            e = gantt._correct_dst_change(e, o, e, r),
            gantt.date[r + "_start"] && (e = gantt.date[r + "_start"](e))
        }
...
gantt._dp_init = function(t) {
    ...
    t.setGanttMode = function(e) {
        ...
        t._in_progress = a._in_progress,
        t._invalid = a._invalid,
        t.updatedRows = a.updatedRows,
        t.modes = n,
        t._ganttMode = e
    }
    ,
    ...
    t.afterUpdate = function() {
        ...
        var n = t._ganttMode
          , a = e.filePath;
        n = "REST" != this._tMode ? -1 != a.indexOf("gantt_mode=links") ? "links" : "tasks" : a.indexOf("/link") > a.indexOf("/task") ? "links" : "tasks",
        t.setGanttMode(n);
        var s = i.apply(t, arguments);
        return t.setGanttMode(n),
        s
    }
    ,
    t._getRowData = gantt.bind(function(e, n) {
        ...
        a.$no_end && (a.end_date = "",
        a.duration = ""),
        i[t.action_param] = this.getUserData(e, t.action_param),
        i
    }, this),
    this._change_id = gantt.bind(function(e, n) {
...
gantt._init_link = function(t) {
    return gantt.defined(t.id) || (t.id = gantt.uid()),
    t
}
,
gantt._sync_links = function() {
    ...
    for (var a in this._lpull) {
        var i = this._lpull[a];
        this._links.push(i),
        this._pull[i.source] && this._pull[i.source].$source.push(a),
        this._pull[i.target] && this._pull[i.target].$target.push(a)
    }
}
,
gantt.getLink = function(t) {
    return gantt.assert(this._lpull[t], "Link doesn't exist"),
    this._lpull[t]
}
,
...
gantt.updateLink = function(t, e) {
    return gantt.defined(e) || (e = this.getLink(t)),
...
gantt._get_skin = function(t) {
    ...
    s._lightbox_template && (gantt._lightbox_template = s._lightbox_template),
    gantt.resetLightbox()
}
,
...
gantt.getLightbox = function(t) {
    ...
    !this._lightbox || this.getLightboxType() != this._get_safe_type(t)) {
        ...
        for (var a, i = this._lightbox_template, s = this.config.buttons_left, r = 0; r < s.length; r++) {
            ...
            a = this._waiAria.lightboxButtonAttrString(o),
            i += "<div " + a + " class='gantt_btn_set gantt_left_btn_set " + o + "_set'><div dhx_button='1' class='" + o + "'></div><div>" + this.locale.labels[o] + "</div></div>"
        }
        s = this.config.buttons_right;
        for (var r = 0; r < s.length; r++) {
            var o = this.config._migrate_buttons[s[r]] ? this.config._migrate_buttons[s[r]] : s[r];
            a = this._waiAria.lightboxButtonAttrString(o),
            i += "<div " + a + " class='gantt_btn_set gantt_right_btn_set " + o + "_set' style='float:right;'><div dhx_button='1' class='" + o + "'></div><div>" + this.locale.labels[o] + "</div></div>";
        }
        i += "</div>",
        e.innerHTML = i,
        gantt._waiAria.lightboxAttr(e),
        ...
        for (var r = 0; r < _.length; r++) {
            ...
            if (g.id && document.getElementById(g.id)) {
                ...
                if (u) {
                    ...
                    f && (g.inputId = f.id || "input_" + gantt.uid(),
                    f.id || (f.id = g.inputId),
...
gantt._render_sections = function(t) {
    for (var e = "", n = 0; n < t.length; n++) {
        ...
        if (a) {
            ...
            this.config.wide_form && (e += "<div class='gantt_wrap_section' " + i + ">"),
            e += "<div id='" + t[n].id + "' class='gantt_cal_lsection'><label>" + s + this.locale.labels["section_" + t[n].name] + "</label></div>" + a.render.call(this, t[n]),
            e += "</div>"
        }
    }
    return e
...
gantt._center_lightbox = function(t) {
    if (t) {
        ...
        e ? t.style.top = Math.round(e + Math.max((a - t.offsetHeight) / 2, 0)) + "px" : t.style.top = Math.round(Math.max((a - t.offsetHeight) / 2, 0) + 9) + "px",
...
gantt._init_lightbox_events = function() {
    ...
    gantt.lightbox_events["default"] = function(t, e) {
        if (e.getAttribute("dhx_button"))
            ...
            i = e.parentNode.parentNode) : (n = e.getAttribute("index"),
            i = e.parentNode,
            e = e.firstChild));
            var r = gantt._get_typed_lightbox_config();
            n && (a = gantt.form_blocks[r[n].type],
...
gantt._set_lightbox_values = function(t, e) {
    var n = t
      ...
      , i = [];
    gantt.templates.lightbox_header ? (i.push(""),
    i.push(gantt.templates.lightbox_header(n.start_date, n.end_date, n)),
    a[1].innerHTML = "",
    a[2].innerHTML = gantt.templates.lightbox_header(n.start_date, n.end_date, n)) : (i.push(this.templates.task_time(n.start_date, n.end_date, n)),
    i.push((this.templates.task_text(n.start_date, n.end_date, n) || "").substr(0, 70)),
    a[1].innerHTML = this.templates.task_time(n.start_date, n.end_date, n),
    a[2].innerHTML = (this.templates.task_text(n.start_date, n.end_date, n) || "").substr(0, 70)),
    a[1].innerHTML = i[0],
    a[2].innerHTML = i[1],
    gantt._waiAria.lightboxHeader(e, i.join(" "));
    for (var s = this._get_typed_lightbox_config(this.getLightboxType()), r = 0; r < s.length; r++) {
        ...
        if (this.form_blocks[o.type]) {
            ...
            l.set_value.call(gantt, _, g, n, o),
            o.focus && l.focus.call(gantt, _)
        }
    }
...
gantt.form_blocks = {
    getTimePicker: function(t, e) {
        ...
        var a = this.config
          ...
          , s = 1440
          , r = 0;
        gantt.config.limit_time_select && (s = 60 * a.last_hour + 1,
        r = 60 * a.first_hour,
        ...
        for (var o = "", _ = 0; _ < n.length; _++) {
            ...
            case "%Y":
                ...
                break;
            case "%m":
                t._time_format_order[1] = _,
                t._time_format_order.size++;
                for (var f = 0; 12 > f; f++)
                    d += "<option value='" + f + "'>" + this.locale.date.month_full[f] + "</option>";
                break;
            case "%d":
                t._time_format_order[0] = _,
                t._time_format_order.size++;
                for (var f = 1; 32 > f; f++)
                    d += "<option value='" + f + "'>" + f + "</option>";
                break;
            case "%H:%i":
                t._time_format_order[3] = _,
                t._time_format_order.size++;
                var f = r
                  , p = i.getDate();
                for (t._time_values = []; s > f; ) {
                    var v = this.templates.time_picker(i);
                    d += "<option value='" + f + "'>" + v + "</option>",
                    t._time_values.push(f),
                    i.setTime(i.valueOf() + 60 * this._get_timepicker_step() * 1e3);
    ...
    select: {
        ...
        set_value: function(t, e, n, a) {
            ...
            i._dhx_onchange = !0),
            "undefined" == typeof e && (e = (i.options[0] || {}).value),
            i.value = e || ""
        },
        get_value: function(t, e) {
    ...
    time: {
        ...
        set_value: function(t, e, n, a) {
            ...
            if (i.auto_end_date)
                for (var o = function() {
                    d = new Date(s[r[2]].value,s[r[1]].value,s[r[0]].value,0,0),
                    g = gantt.calculateEndDate(d, 1),
    ...
    duration: {
        ...
        set_value: function(t, e, n, a) {
            ...
            d[1].onclick = gantt.bind(function() {
                s(1 * this.config.duration_step)
            }, this),
            o[0].onchange = i,
            o[1].onchange = i,
            o[2].onchange = i,
            o[3] && (o[3].onchange = i),
            l.onkeydown = gantt.bind(function(t) {
                t = t || window.event;
            ...
            l.onchange = gantt.bind(function(t) {
                i()
            }, this);
            ...
            gantt.form_blocks._fill_lightbox_select(o, 0, u, h, r),
            l.value = p,
            i()
        },
    ...
    parent: {
        _filter: function(t, e, n) {
            ...
            for (var i = 0; i < t.length; i++) {
                var s = t[i];
                (s.id == n || gantt.isChildOf(s.id, n) || a(s.id, s) === !1) && (t.splice(i, 1),
                i--)
            }
            return t
        },
    ...
    var e = t
      , n = {
        ...
        set_value: function(t, a, i, s) {
            ...
            return n.enable(t, s),
            e.set_value.call(gantt, t, a, i, s)
        },
...
gantt.dataProcessor.prototype = {
    ...
    setUpdated: function(t, e, n) {
        if (!this._silent_mode) {
            ...
            this._in_progress[t] && (this._in_progress[t] = "wait")) : this.is_invalid(t) || (this.updatedRows.splice(a, 1),
    ...
    markRow: function(t, e, n) {
        var a = ""
          , i = this.is_invalid(t);
        if (i && (a = this.styles[i],
        e = !0),
        this.callEvent("onRowMark", [t, e, n, i]) && (a = this.styles[e ? n : "clear"] + a,
    ...
    serialize: function(t, e) {
        ...
        gantt.security_key && n.push("dhx_security=" + gantt.security_key),
        n.join("&")
    },
        ...
        for (var a in t)
            if (t.hasOwnProperty(a)) {
                if (("id" == a || a == this.action_param) && "REST" == this._tMode)
                    continue;n.push(this.escape((e || "") + a) + "=" + this.escape(t[a]))
            }
        return n.join("&")
    },
        ...
        if (t) {
            ...
            if ("GET" == this._tMode)
                ...
                var s = this.getState(e)
                  ...
                  , o = ""
                  , _ = "post";
                if ("inserted" == s ? o = this.serialize(t, e) : "deleted" == s ? (_ = "DELETE",
                r = r + ("/" == r.slice(-1) ? "" : "/") + e) : (_ = "PUT",
    ...
    _getAllData: function(t) {
        for (var e = {}, n = !1, a = 0; a < this.updatedRows.length; a++) {
            ...
            this._in_progress[i] || this.is_invalid(i) || this.callEvent("onBeforeUpdate", [i, this.getState(i), this._getRowData(i)]) && (e[i] = this._getRowData(i, i + this.post_delim),
            n = !0,
    ...
    afterUpdateCallback: function(t, e, n, a) {
        ...
        "wait" != this._in_progress[i] ? (s && this.obj.setUserData(t, this.action_param, ""),
        delete this._in_progress[i]) : (delete this._in_progress[i],
        ...
        if (window.JSON) {
            ...
            if (a) {
                var s = a.action || this.getState(n) || "updated"
                  , r = a.sid || n[0]
                  , o = a.tid || n[0];
                return t.afterUpdateCallback(r, o, s, a),
    ...
    setAutoUpdate: function(t, e) {
        ...
        this._need_update = !1,
        this._update_busy = !1,
        this.attachEvent("onAfterUpdate", function(t, e, n, a) {
...
gantt._insert_callback = function(t, e, n, a) {
    ...
    "links" == a && (s.add = gantt.addLink,
    s.isExist = gantt.isLinkExists),
    s.isExist.call(gantt, e) || (i.id = e,
    s.add.call(gantt, i))
}
,
gantt._delete_callback = function(t, e, n, a) {
    ...
    "links" == a && (i["delete"] = gantt.deleteLink,
...
gantt._init_html_area = function(t) {
    ...
    this.$scroll_ver = i[2],
    this.$scroll_hor = i[3],
    this.$grid.innerHTML = "<div class='gantt_grid_scale' " + gantt._waiAria.gridScaleRowAttrString() + "></div><div class='gantt_grid_data' " + n + "></div>",
...
gantt._get_box_styles = function() {
    ...
    return i.borderBox ? (i.innerWidth -= i.horPaddings,
    i.innerHeight -= i.vertPaddings) : (i.outerWidth += i.horPaddings,
...
gantt._do_autosize = function() {
    ...
    if (t.x) {
        ...
        e.borderBox && (a += e.horPaddings),
        this._obj.style.width = a + "px"
    }
}
,
...
gantt._save_scroll_state = function(t, e) {
    ...
    this.mixin(this._cached_scroll_pos, n, !0)
}
,
...
gantt.scrollTo = function(t, e) {
    ...
    1 * e == e && (this.$scroll_ver.scrollTop = e,
    this.$task_data.scrollTop = e,
    this.$grid_data.scrollTop = e,
    this._save_scroll_state(void 0, this.config.show_chart ? this.$task_data.scrollTop : this.$scroll_ver.scrollTop));
...
gantt.showTask = function(t) {
    ...
    e = i ? n.y - (i - this.config.row_height) / 2 : n.y,
    this.scrollTo(a, e)
}
,
...
gantt._scroll_sizes = function() {
    ...
    return _ && (l.x = Math.max(this._x - (r ? a : 2), 0)),
    r && (l.y = Math.max(this._y - (_ ? a : 0) - this.config.scale_height, 0)),
    l;
}
,
...
gantt.ajax = {
    ...
    parse: function(t) {
        ...
        window.DOMParser && !gantt.env.isIE ? e = (new window.DOMParser).parseFromString(t, "text/xml") : window.ActiveXObject !== window.undefined && (e = new window.ActiveXObject("Microsoft.XMLDOM"),
        e.async = "false",
        e.loadXML(t)),
        e
    },
    xmltop: function(t, e, n) {
        ...
        return -1 !== n && gantt.callEvent("onLoadXMLError", ["Incorrect XML", arguments[1], n]),
        ...
        if (a && (o.onreadystatechange = function() {
            if (4 == o.readyState || _ && 3 == o.readyState) {
                ...
                window.setTimeout(function() {
                    ...
                    s && ("undefined" != typeof s.postData ? gantt.ajax.postLong(s.url, s.postData, i) : gantt.ajax.getLong(s.url, i)),
                    i = null ,
                    o = null
                }, 1)
            }
...
function() {
        ...
        if (c) {
            ...
            if (gantt.message.keyboard) {
                if (13 == n || 32 == n) {
                    ...
                    gantt._getClassName(i).indexOf("gantt_popup_button") > -1 && i.click ? i.click() : (t(c, !0),
                    a = !0)
                }
                27 == n && (t(c, !1),
                a = !0)
    ...
    function i(t) {
        ...
        ,
        gantt._waiAria.messageInfoAttr(e),
    ...
    function r(e, n, i) {
        var r = document.createElement("DIV")
          , o = gantt.uid();
        gantt._waiAria.messageModalAttr(r, o),
        r.className = " gantt_modal_box dhtmlx_modal_box gantt-" + e.type + " dhtmlx-" + e.type,
        r.setAttribute("dhxbox", 1);
        var _ = "";
        if (e.width && (r.style.width = e.width),
        e.height && (r.style.height = e.height),
        e.title && (_ += '<div class="gantt_popup_title dhtmlx_popup_title">' + e.title + "</div>"),
        _ += '<div class="gantt_popup_text dhtmlx_popup_text" id="' + o + '"><span>' + (e.content ? "" : e.text) + '</span></div><div  class="gantt_popup_controls dhtmlx_popup_controls">',
        n && (_ += a(s(e.ok, gantt.locale.labels.message_ok, "OK"), !0)),
        i && (_ += a(s(e.cancel, gantt.locale.labels.message_cancel, "Cancel"), !1)),
        e.buttons)
    ...
    function o(t, a, i) {
        ...
        return "top" == t.position ? s.style.top = "-3px" : s.style.top = _ + "px",
        s.style.left = o + "px",
        s.onkeydown = e,
        gantt.modalbox.focus(s),
        t.hidden && gantt.modalbox.hide(s),
        gantt.callEvent("onMessagePopup", [s]),
        s
    }
    function _(t) {
        return o(t, !0, !1)
...
gantt.date = {
    ...
    parseDate: function(t, e) {
        return "string" == typeof t && (gantt.defined(e) && (e = "string" == typeof e ? gantt.defined(gantt.templates[e]) ? gantt.templates[e] : gantt.date.str_to_date(e) : gantt.templates.xml_date),
        t = t ? e(t) : null ),
        t
    }
},
...
gantt._touch_events = function(t, e, n) {
    ...
    gantt.event(gantt.$container, t[0], function(t) {
        if (!n(t) && o) {
            ...
            if (gantt._tasks_dnd.drag.id || gantt._tasks_dnd.drag.start_drag)
                return gantt._tasks_dnd.on_mouse_move(i),
            ...
            if (!gantt._prevent_touch_scroll) {
                if (i && l) {
                    var g = l.pageX - i.pageX
                      , h = l.pageY - i.pageY;
                    if (!_ && (Math.abs(g) > 5 || Math.abs(h) > 5) && (gantt._touch_scroll_active = _ = !0,
                    r = 0,
    ...
    gantt.event(this.$container, t[1], function(t) {
        if (!n(t)) {
            ...
            d = setTimeout(function() {
                ...
                gantt._tasks_dnd.drag && gantt._tasks_dnd.drag.start_drag && (i(t),
    ...
    gantt.event(this.$container, t[2], function(t) {
        if (!n(t)) {
            ...
            o = !1;
            var a = e(t);
            gantt._tasks_dnd.on_mouse_up(a),
            g && (gantt.refreshTask(gantt.locate(g)),
...
function() {
    function t(t, e) {
        var n = gantt.env.isIE ? "" : "%c"
          ...
          , s = [a];
        gantt.env.isIE || (s = s.concat(["font-weight:bold", "font-weight:normal", "font-weight:bold", "font-weight:normal"])),
        i.apply(window.console, s)
    }
    function e(e) {
        return function() {
            return t("dhtmlx." + e, "gantt." + e),
            gantt[e].apply(gantt, arguments)
        }
    }
