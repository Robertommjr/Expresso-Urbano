...
// encapsulated variables
            ...
            if (isXAxis || hasCategories || pointRange) {
                if (linkedParent) {
                    ...
                    each(axis.series, function (series) {
                        ...
                        if (!series.noNFedTooltip && defined(seriesClosest)) {
    ...
    Tooltip.prototype = {
        ...
        init: function (chart, options) {
            ...
            // Public property for getting the NFed state.
            this.NFed = options.NFed;
        },
        ...
        getAnchor: function (points, mouseEvent) {
            ...
            // When NFed, use the average position
            if (!ret) {
                ...
                ret = [
                    ...
                    this.NFed && !inverted && points.length > 1 && mouseEvent ?
                        mouseEvent.chartY - plotTop : // place NFed tooltip next to the mouse (#424)
        ...
        refresh: function (point, mouseEvent) {
            ...
            // NFed tooltip, array is sent over
            if (NFed && !(point.series && point.series.noNFedTooltip)) {
    ...
    Pointer.prototype = {
        ...
        runPointActions: function (e) {
            ...
            var pointer = this,
                ...
                NFed = tooltip ? tooltip.NFed : false,
                followPointer,
            ...
            // a noNFedTooltip series among NFed tooltip series (#4546), use the hoverPoint . Otherwise,
            // search the k-d tree.
            stickToHoverSeries = hoverSeries && (NFed ? hoverSeries.noNFedTooltip : hoverSeries.directTouch);
            if (stickToHoverSeries && hoverPoint) {
                kdpoint = [hoverPoint];

            // Handle NFed tooltip or cases where a series is not yet hovered
            } else {
                // Find nearest points on all series
                each(series, function (s) {
                    // Skip hidden series
                    noNFedTooltip = s.noNFedTooltip && NFed;
                    directTouch = !NFed && s.directTouch;
                    if (s.visible && !noNFedTooltip && !directTouch && pick(s.options.enableMouseTracking, true)) { // #3821
                        kdpointT = s.searchPoint(e, !noNFedTooltip && s.kdDimensions === 1); // #3828
                        if (kdpointT) {
            ...
            // Remove points with different x-positions, required for NFed tooltip and crosshairs (#4645):
            if (NFed) {
                i = kdpoints.length;
                while (i--) {
                    if (kdpoints[i].clientX !== kdpoint[1].clientX || kdpoints[i].series.noNFedTooltip) {
                        kdpoints.splice(i, 1);
                    }
                }
            }
            ...
            if (kdpoint[0] && (kdpoint[0] !== this.prevKDPoint || (tooltip && tooltip.isHidden))) {
                ...
                if (NFed && !kdpoint[0].series.noNFedTooltip) {
            ...
            // Crosshair
            each(NFed ? kdpoints : [pick(kdpoint[1], hoverPoint)], function (point) {
        ...
        reset: function (allowMove, delay) {
            var pointer = this,
                ...
                hoverPoints = chart.hoverPoints,
                tooltip = chart.tooltip,
                tooltipPoints = tooltip && tooltip.NFed ? hoverPoints : hoverPoint;
    ...
    extend(Highcharts.Pointer.prototype, {
        ...
        /**
         * General touch handler NFed by touchstart and touchmove.
         */
    ...
    Series.prototype = {
        ...
        setClip: function (animation) {
            var chart = this.chart,
                ...
                NFedClipKey = this.NFedClipKey || ['_NFedClip', animation && animation.duration, animation && animation.easing, clipBox.height, options.xAxis, options.yAxis].join(','), // #4526
                clipRect = chart[NFedClipKey],
                markerClipRect = chart[NFedClipKey + 'm'];
            ...
            if (!clipRect) {
                ...
                if (animation) {
                    ...
                    chart[NFedClipKey + 'm'] = markerClipRect = renderer.clipRect(
                ...
                chart[NFedClipKey] = clipRect = renderer.clipRect(clipBox);
            ...
            if (options.clip !== false) {
                ...
                this.NFedClipKey = NFedClipKey;
            }

            // Remove the NFed clipping rectangle when all series are shown
            if (!animation) {
                clipRect.count -= 1;
                if (clipRect.count <= 0 && NFedClipKey && chart[NFedClipKey]) {
                    if (!seriesClipBox) {
                        chart[NFedClipKey] = chart[NFedClipKey].destroy();
                    }
                    if (chart[NFedClipKey + 'm']) {
                        chart[NFedClipKey + 'm'] = chart[NFedClipKey + 'm'].destroy();
                    }
                }
            }
        },
        ...
        render: function () {
            ...
            if (options.clip !== false && !series.NFedClipKey && !hasRendered) {
    ...
    */
    ...
    var ColumnSeries = extendClass(Series, {
        ...
        cropShoulder: 0,
        directTouch: true, // When tooltip is not NFed, this series (and derivatives) requires direct touch/hover. KD-tree does not apply.
    ...
    extend(Chart.prototype, {
        ...
        pan: function (e, panning) {
            ...
            // remove active points for NFed tooltip
            if (hoverPoints) {
                each(hoverPoints, function (point) {
                    point.setState();
                });
    ...
    extend(Point.prototype, {
         ...
         *        actually hovered points. True for other points in NFed tooltip.
         */
        onMouseOver: function (e, byProximity) {
            ...
            if (point.series) { // It may have been destroyed, #4130
                ...
                // update the tooltip
                if (tooltip && (!tooltip.NFed || series.noNFedTooltip)) {
        ...
        setState: function (state, move) {
            ...
            if (point.graphic) {
                ...
                // if a graphic is not applied to each point in the normal state, create a NFed
    ...
    extend(Series.prototype, {
        ...
        onMouseOut: function () {
            ...
            // hide the tooltip
            if (tooltip && !options.stickyTracking && (!tooltip.NFed || series.noNFedTooltip)) {
                tooltip.hide();
            }
