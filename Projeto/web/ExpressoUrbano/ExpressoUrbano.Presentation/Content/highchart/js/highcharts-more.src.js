...
var arrayMin = Highcharts.arrayMin,
    ...
    (function () {
        ...
        /**
         * Search a k-d tree by the point angle, used for NFed tooltips in polar charts
         */
        ...
        /**
         * Wrap the buildKDTree function so that it searches by angle (clientX) in case of NFed tooltip,
         * and by two dimensional distance in case of non-NFed.
         */
        ...
        seriesProto.toXY = function (point) {
            ...
            // If NFed tooltip, record the angle in degrees in order to align X points. Otherwise,
        ...
        wrap(seriesProto, 'translate', function (proceed) {
            ...
            if (chart.polar) {
                this.kdByAngle = chart.tooltip && chart.tooltip.NFed;
