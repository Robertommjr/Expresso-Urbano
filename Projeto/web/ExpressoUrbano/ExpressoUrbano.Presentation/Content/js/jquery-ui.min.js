    ...
    t.extend(i.prototype, {
        ...
        _attachments: function(e, i) {
            ...
            i.append && i.append.remove(), a && (i.append = t("<span class='" + this._appendClass + "'>" + a + "</span>"), e[r ? "before" : "after"](i.append)), e.unbind("focus", this._showDatepicker), i.trigger && i.trigger.remove(), s = this._get(i, "showOn"), ("focus" === s || "both" === s) && e.focus(this._showDatepicker), ("button" === s || "both" === s) && (n = this._get(i, "buttonText"), o = this._get(i, "buttonImage"), i.trigger = t(this._get(i, "buttonImageOnly") ? t("<img/>").addClass(this._triggerClass).attr({
                ...
                alt: n,
                title: n
            }) : t("<button style='margin-right: 10px;' type='button'></button>").addClass(this._triggerClass).html(o ? t("<img/>").attr({
                src: o,
                alt: n,
                title: n
...
function(t) {
    ...
    t.widget("ui.dialog", {
        ...
        _createWrapper: function() {
            this.uiDialog = t("<div style='padding: 10px; background-color: #37383A; border: #F00 solid; '> ").addClass("ui-dialog ui-widget ui-widget-content ui-corner-all ui-front " + this.options.dialogClass).hide().attr({
                tabIndex: -1,
                role: "dialog"
        ...
        _createTitlebar: function() {
            ...
            }), this.uiDialogTitlebarClose = t("").button({
